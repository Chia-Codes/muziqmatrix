...
=======
      ![Games Button](docs/readme_images/games-btn.webp) -----------------------------
>>>>>>> 0a181baea84a6468938bf15d101eb0948c4a6add
...
**Fix**: This is not currently fixed <-------------------------------------------------------------------->
...
![CSS Validator](docs/readme_images/html-validator-test)

### JavaScript
- Multiple errors returned passing through
